...
// import MovieCard from "../components/MovieCard";
// import { Link } from "react-router-dom";
// import "./Favorites.css"; // We'll create this separate CSS file
...
//   useEffect(() => {
//     console.log("🔵 Favorites: Setting up auth listener");
    
//     const unsubscribeAuth = auth.onAuthStateChanged((currentUser) => {
//       console.log("🔵 Favorites: Auth state changed", currentUser?.uid);
//       setUser(currentUser);
      
//       if (!currentUser) {
//         console.log("🔵 Favorites: No user, clearing movies");
//         setLoading(false);
//         setMovies([]);
//         return;
//       }
...
//       const favRef = ref(database, `favorites/${currentUser.uid}`);
//       console.log("🔵 Favorites: Setting up Firebase listener for:", `favorites/${currentUser.uid}`);
      
//       const unsubscribe = onValue(
//         favRef,
//         (snapshot) => {
//           console.log("🔵 Favorites: Firebase data received");
//           const data = snapshot.val();
//           console.log("🔵 Favorites: Raw data:", data);
          
//           if (data) {
//             const movieList = Object.values(data);
//             console.log("🔵 Favorites: Parsed movie list:", movieList);
//             setMovies(movieList);
//           } else {
//             console.log("🔵 Favorites: No data found");
//             setMovies([]);
//           }
//           setLoading(false);
//         },
//         (error) => {
//           console.error("❌ Favorites: Firebase listener error:", error);
//           setLoading(false);
//           setMovies([]);
//         }
//       );
...
//       return () => {
//         console.log("🔵 Favorites: Cleaning up Firebase listener");
//         unsubscribe();
//       };
//     });

//     return () => {
//       console.log("🔵 Favorites: Cleaning up auth listener");
//       unsubscribeAuth();
//     };
//   }, []);
...
//       case 'recent':
//       default:
//         return sortedMovies.sort((a, b) => (b.addedAt || 0) - (a.addedAt || 0));
//     }
//   };
...
//               <div className="movies-grid">
//                 {sortedMovies.map((movie) => (
//                   <div key={movie.imdbID || movie.id} className="grid-item">
...
//                   return (
//                     <div key={movie.imdbID || movie.id} className="list-item">
//                       <div className="list-number">{index + 1}</div>
//                       <div className="list-poster">
//                         <img 
//                           src={posterUrl}
...
//                       </div>
//                       <div className="list-info">
//                         <h3 className="list-title">{movie.Title || movie.title}</h3>
//                         <p className="list-year">Released in {movie.Year || 'N/A'}</p>
//                         <p className="list-type">{movie.Type?.charAt(0).toUpperCase() + movie.Type?.slice(1) || 'Movie'}</p>
//                         {movie.vote_average && (
//                           <p className="list-rating">⭐ {movie.vote_average.toFixed(1)} / 10</p>
//                         )}
//                       </div>
//                       <div className="list-actions">
//                         <Link to={`/movie/${movie.id || movie.imdbID}`} className="view-btn">
//                           View Details
//                         </Link>
//                       </div>
//                     </div>
...
//     switch (sortBy) {
//       case 'alphabetical':
//         return sortedMovies.sort((a, b) => (a.Title || a.title || '').localeCompare(b.Title || b.title || ''));
//       case 'year':
//         return sortedMovies.sort((a, b) => (b.Year || 0) - (a.Year || 0));
//       case 'recent':
//       default:
